...
CPU = 0
GPU = 0
path_to_B0 = "klok_resultaten/B0/"

for filename in glob(path_to_B0 + "*.output"):
...
pyl.ylabel("Sky model conversion time (s)", fontsize = marker_size)
...
pyl.legend(loc = 2)
# pyl.title("Sagecal sky model conversion times for five numbers of stations", fontsize = int(marker_size))
bbox_props = dict(boxstyle="round", fc="w", ec="0.5", alpha=0.9)
pyl.text(60, 0.65, "LOFAR", ha="center", va="center", size=20, bbox=bbox_props)
pyl.text(512, 35, "SKA", ha="center", va="center", size=20, bbox=bbox_props)
# pyl.show()
pyl.savefig(path_to_B0 + "Sagecal_sky_model_conversion_times.png", bbox_inches = "tight")
