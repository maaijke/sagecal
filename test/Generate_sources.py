...
with open(str(number_of_sources)+ "_sources_half_of_them_Gaussians_half_pointlike_centered_on_NCP_with_" + str(number_of_clusters) + "_clusters.txt.cluster", 'wb') as f:
